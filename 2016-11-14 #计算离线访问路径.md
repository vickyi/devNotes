...
yarn jar ./pathlist.jar com.abcplus.bi.mapred.OfflinePathList "$dt"
## >> /home/hadoop/users/vk/jars/out_pathlist_2016-11-10.log 2>&1
...
hive  -d dbName=$DB -d tableName=$TABLE -d date=$dt -f ./load_to_hive.sql
## >> ./out_load_to_hive_$dt.log 2>&1
