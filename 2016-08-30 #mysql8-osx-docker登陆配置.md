...
#### error info 2
```
Unable to connect to host 192.168.96.145, or the request timed out.
...
### docker run mysql
```
docker run -it --rm mysql mysql -h192.168.96.145 -uroot -p
...
### hosts:192.168.96.145:8088

mysql://root:123456@192.168.96.145:3306/superset?charset=utf8
```
...
#### 创建新用户 develop
```
create user develop@'192.168.96.145' identified WITH mysql_native_password BY 'develop';
grant all privileges on *.* to develop@'192.168.96.145' with grant option;
flush privileges;

mysql -h192.168.96.145 -udevelop -p
